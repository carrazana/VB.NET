...
Public Class InsumosMasUsados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ConsultorioOdontologico.InsumosMasUsados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInsumosMasUsados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InsumosMasUsados = New InsumosMasUsados()
        rpt.Site = Me.Site
        Return rpt
    End Function
