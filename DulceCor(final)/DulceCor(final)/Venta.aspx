<%@ Page Title="" Language="C#" MasterPageFile="~/DulceCor.Master" AutoEventWireup="true" CodeBehind="Venta.aspx.cs" Inherits="DulceCor_final_.Venta" %>
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <asp:Repeater ID="rptTipoGolosina" runat="server">
                        <ItemTemplate>
                            <a href='Venta.aspx?idTipoGolosina=<%# Eval("idTipoGolosina") %>' class="list-group-item"><%# Eval("nombre") %></a>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>              
                    ...
                    <asp:Repeater ID="rptGolosinas" runat="server" OnItemCommand="rptGolosinas_ItemCommand"  >
                        <ItemTemplate>
                            <div class="col-sm-4 col-lg-4 col-md-4" >
                                <div class="thumbnail">
                                    <img src="<%# Eval("imagen") %>" alt="" width="320" height="240" >
                                    <div class="caption" >
                                        
                                        <h4><a href="#"><%# Eval("nombre") %></a></h4>     
                                        <h4><%# Eval("marca") %></a></h4>         
                                                                                                      
                                      <asp:Button ID="btnComprar" runat="server" Text="Comprar" CssClass="btn btn-primary" CommandArgument='<%#Eval("idGolosina") %>' CommandName="Comprar" />
                                        ...
                                        <asp:TextBox ID="txtCantidad" runat="server" Width="40" placeHolder="Cant." Text="1"></asp:TextBox>
                                         <h4 class="pull-right"><%# Eval("precio","${0:###,###,###.00}") %></h4>
                                    </div>                               
                                </div>
                            </div>
